...
concurrency algorithms. NUMA systems take care to address the asymmatry of
memory accesses and divide operations into local and remote. This asymmetry
exists in the disaggregated context
...
manipulation requires server side processing it is not directly applicable.
