...
its lowest cost, it will still be much more expensive than a local memory
...
of its remote memory operations are performed via one-side RDMA, with the
...
way its only cousin in this work is Sherman, as they both require careful use
...
definitions of its structures, such as the virtual memory space of remote
