...
algorithms and data structures have been developed with programable network
...
disaggregation are not new, and many practical approaches can be mined from
prior literature designed to scale software to many cores, or directly access
