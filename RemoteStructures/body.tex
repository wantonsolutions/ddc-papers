...
\multirow{3}{*}{\rotatebox[origin=c]{90}{\shortstack{\small Disaggregated \\ \small Datastructures }}}        & Clover~\cite{clover}                                    &  &  &  &  &  &  &  &  \\ \cdashline{2-10}
         & \shortstack{Concious \\Hashing}~\cite{write-op-hash}            &  &  &  &  &  &  &  &  \\ \cdashline{2-10}
