...
exist, allowing for uncontested access to shared structures.  ~\cite{}\todo{add
all concurrent structures}. Similarly the advent of NUMA servers lead to the
production of new locality aware algorithms and data structures which scale to
thousands of cores.  ~\cite{linux-scale,black-box-numa}\todo{many cites for
numa}. The common thread that ties these two approaches to the concept of
...
\begin{table*}[t]
    ...
    \begin{tabular}{ c | c | c | c | c | c | c | c | c }
        & \shortstack{read \\ inflation} & \shortstack{relaxed  \\ layout} & \shortstack{pre-\\computation} & \shortstack{optimistic \\ concurrency} & \shortstack{metadata \\ caching} & \shortstack{client \\ coalescing} & \shortstack{write \\ amplification} & \shortstack{self \\ verifing}  \\ \hline
                                                                %N          %R          %P          %O          %M          %C          %W          %S
      pilaf~\cite{pilaf}                                      & \nullcirc & \nullcirc & \nullcirc & \nullcirc & \nullcirc & \nullcirc & \nullcirc & \fullcirc \\ \hdashline
      farm~\cite{farm}                                        & \fullcirc & \nullcirc & \nullcirc & \fullcirc & \fullcirc & \fullcirc & \nullcirc & \nullcirc \\ \hdashline
      herd~\cite{herd}                                        & \nullcirc & \nullcirc & \nullcirc & \nullcirc & \nullcirc & \nullcirc & \nullcirc & \nullcirc \\ \hdashline
      cell~\cite{cell}                                        & \nullcirc & \nullcirc & \nullcirc & \nullcirc & \fullcirc & \nullcirc & \nullcirc & \fullcirc \\ \hdashline
      % fasst~\cite{faast}                                      & \nullcirc & \nullcirc & \nullcirc & \nullcirc & \nullcirc & \nullcirc & \nullcirc & \nullcirc \\ \hdashline
      % erpc~\cite{erpc}                                        & \nullcirc & \nullcirc & \nullcirc & \nullcirc & \nullcirc & \nullcirc & \nullcirc & \nullcirc \\ \hdashline
      storm~\cite{storm}                                      &  &  &  &  &  &  &  &  \\ \hdashline
      1RMA~\cite{1rma}                                        &  &  &  &  &  &  &  &  \\ \hline
      \shortstack{Flat \\ Combining}~\cite{flat-combine}      &  &  &  &  &  &  &  &  \\ \hdashline
      \shortstack{Hopscotch \\ Hash}~\cite{hopscotch}         &  &  &  &  &  &  &  &  \\ \hline
      \shortstack{Blackbox \\ NUMA}~\cite{black-box-numa}     &  &  &  &  &  &  &  &  \\ \hline \hline
      Clover~\cite{clover}                                    &  &  &  &  &  &  &  &  \\ \hline
      \shortstack{Concious \\Hashing}~\cite{write-op-hash}    &  &  &  &  &  &  &  &  \\ \hline
      Sherman~\cite{Sherman}   & & & & & & & \\ \hline \hline
