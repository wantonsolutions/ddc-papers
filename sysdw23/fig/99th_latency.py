...
fig, (ax1, ax2) = plt.subplots(1 ,2, figsize=(6,4), gridspec_kw={'width_ratios': [2,2]})
...
rects0 = ax1.bar(x - width/2, reads(clover), width, label='Clover',color=default_clover_color,edgecolor='k')
# rects1 = ax1.bar(x, reads(write), width, label='Write',color=write_steering_color,edgecolor='k')
rects2 = ax1.bar(x + width/2 , reads(read), width, label='Swordbox',color=read_write_steering_color,edgecolor='k')
...
rects0 = ax2.bar(x - width/2, writes(clover), width, label='Clover',color=default_clover_color,edgecolor='k')
# rects1 = ax2.bar(x, writes(write), width, label='Write',color=write_steering_color,edgecolor='k')
rects2 = ax2.bar(x + width/2 , writes(read), width, label='Swordbox',color=read_write_steering_color,edgecolor='k')
