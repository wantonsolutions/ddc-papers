...
def run_search_dependence():
    ...
    master_config['state_machine'] = cuckoo.rcuckoo
...
def plot_search_dependence():
    ...
    h1 = ax.errorbar(x,random_independent_rtt,yerr=random_independent_err, linestyle="-", marker="o", label="random hashing")
    ...
    h1 = ax.errorbar(x,a_star_dependent_rtt,yerr=a_star_dependent_err, linestyle="-", marker="s", label="a star (Rcuckoo)")
